...
<div id="slider-cycle" class="slider cycle no-responsive slider_cycle group" style="height:485px;">
    <ul class="slider">
        ...
        @set($i, 1)
        @foreach($slider as $item_key => $item)
            <li>
                <div class="slide-holder" style="background:  url('{{asset(env('THEME'))}}/images/{{ $item->img }}') no-repeat center center" style="height:483px;">
                    ...
                    @else
                            <div class="slide-content-holder-content" style="position: absolute; top:30px;left:500px;">
        ...
        {{--<li>
            <div class="slide-holder" style="background:  url('http://corporate.loc/pink/images/slider-cycle/xx.jpg') no-repeat center center" style="height:483px;">
                <div class="slide-content-holder inner" style="height:483px;">
                    <div class="slide-content-holder-content" style="position: absolute; top:30px;right:650px;">
                        <div class="slide-title">
        ...
        <li>
            <div class="slide-holder" style="background:  url('http://corporate.loc/pink/images/slider-cycle/00314.jpg') no-repeat center center" style="height:483px;">
                <div class="slide-content-holder inner" style="height:483px;">
        ...
        <li>
            <div class="slide-holder" style="background:  url('http://corporate.loc/pink/images/slider-cycle/dd.jpg') no-repeat center center" style="height:483px;">
                <div class="slide-content-holder inner" style="height:483px;">
                </div>
            </div>
        </li>--}}
