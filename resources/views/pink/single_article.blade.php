...
{{--            {{ dump($article) }}--}}
            ...
            <div class="meta group">
                ...
                <p class="categories">
                    <span>In:
                        <a href="blog-big-image.html" title="View all posts in Design" rel="category tag">Design</a>,
                ...
                <p class="comments"><span><a href="#comments" title="Comment on This is the title of the first article. Enjoy it.">{{ !$article->comments->isEmpty() ? $article->comments->count() : '0'  }} {{ Lang::choice('ru.comments', $article->comments->count()) }}</a></span></p>
            </div>
            <!-- post content -->
    ...
    <div id="comments">
        <h3 id="comments-title">
            <span>{{ $article->comments->count() }}</span> {{  Lang::choice('ru.comments', $article->comments) }}
        </h3>
